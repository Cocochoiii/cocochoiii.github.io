    ...
    return (
        <div ref={cardRef} className={`proj-card ${className}`}
             style={{
                 ...
                 transition: 'box-shadow 0.5s cubic-bezier(0.25,0,0,1), outline-color 0.4s',
                 boxShadow: hovered ? '0 22px 55px rgba(0,0,0,0.28)' : 'none',
                 outline: hovered ? `2px solid ${p.hBg}40` : '2px solid transparent',
                 outlineOffset: hovered ? 2 : 0,
                 ...style,
             }}
             onMouseMove={onMove}
             onMouseEnter={reveal}
