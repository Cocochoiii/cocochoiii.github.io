    ...
    return (
      ...
      `}</style>
           ...
           */}
            ...
            <ChatSection config={{ ...HOME_CHAT, accent: '#c47a6e', title: 'Ask me anything', subtitle: 'Conversation', bg: '#E37B88', parentBg: '#E37B88', theme: 'light', cardStyle: 'default', titleColor: '#fff' }} />
        </div>
    )
}