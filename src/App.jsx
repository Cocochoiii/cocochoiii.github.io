...
export default function App() {
    ...
    /* ── Chat state persistence across page switches ── */
    const chatStoreRef = useRef({})

    /* ── Preload Rive runtime so page switches are instant ── */
    useEffect(() => { import('@rive-app/canvas').catch(() => {}) }, [])
    ...
    return (
        <>
            <div style={{ position: 'fixed', inset: 0 }}>
                <ActivePage go={go} chatStore={chatStoreRef} />
            </div>
